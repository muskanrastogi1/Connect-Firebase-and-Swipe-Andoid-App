package com.muskanrastogi.connectfirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    void getData(){
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://connectfirebase-7825a-default-rtdb.asia-southeast1.firebasedatabase.app/");
